...
for jet in ["calo","pf"]:
    ...
    canvas.SetTickx()
    canvas.SetTicky()
    psFileName = "%s_btagUnc.pdf" % (jet)
    canvas.Print(psFileName+"[", "Lanscape")
    outFile = r.TFile("%s_btagUnc.root" % jet,"RECREATE")    
    
    dct = {"vn":"375_%sJet_ge2j_bn_jn_in_pn"%jet,
           "vu":"375_%sJet_ge2j_bu_jn_in_pn"%jet,
           "vd":"375_%sJet_ge2j_bd_jn_in_pn"%jet}
